...
public final class BankWithdrawListener extends OasisCommandTranslator {
    public BankWithdrawListener(@NonNull OasisServer server, @NonNull EconomyState state) {
        super(server, state);
    }
