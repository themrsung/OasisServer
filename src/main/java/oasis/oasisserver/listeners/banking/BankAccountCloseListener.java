...
public final class BankAccountCloseListener extends OasisCommandTranslator {
    public BankAccountCloseListener(@NonNull OasisServer server, @NonNull EconomyState state) {
        super(server, state);
    }
