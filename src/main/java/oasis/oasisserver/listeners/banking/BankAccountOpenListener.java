...
public final class BankAccountOpenListener extends OasisCommandTranslator {
    public BankAccountOpenListener(@NonNull OasisServer server, @NonNull EconomyState state) {
        super(server, state);
    }
