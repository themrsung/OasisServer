...
public final class CreateOrganizationListener extends OasisCommandTranslator {
    public CreateOrganizationListener(@NonNull OasisServer server, @NonNull EconomyState state) {
        super(server, state);
    }
