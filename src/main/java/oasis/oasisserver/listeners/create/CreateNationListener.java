...
public final class CreateNationListener extends OasisCommandTranslator {
    public CreateNationListener(@NonNull OasisServer server, @NonNull EconomyState state) {
        super(server, state);
    }
