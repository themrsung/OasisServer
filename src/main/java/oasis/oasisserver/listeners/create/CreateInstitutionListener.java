...
public final class CreateInstitutionListener extends OasisCommandTranslator {
    public CreateInstitutionListener(@NonNull OasisServer server, @NonNull EconomyState state) {
        super(server, state);
    }
