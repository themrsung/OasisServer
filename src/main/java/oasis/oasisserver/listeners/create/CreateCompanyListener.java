...
public final class CreateCompanyListener extends OasisCommandTranslator {
    public CreateCompanyListener(@NonNull OasisServer server, @NonNull EconomyState state) {
        super(server, state);
    }
