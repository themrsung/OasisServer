...
public final class HostilityRevokeListener extends OasisCommandTranslator {
    public HostilityRevokeListener(@NonNull OasisServer server, @NonNull EconomyState state) {
        super(server, state);
    }
