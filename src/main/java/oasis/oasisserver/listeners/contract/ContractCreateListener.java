...
public final class ContractCreateListener extends OasisCommandTranslator {
    public ContractCreateListener(@NonNull OasisServer server, @NonNull EconomyState state) {
        super(server, state);
    }
