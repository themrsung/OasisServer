...
public final class ContractForgiveListener extends OasisCommandTranslator {
    public ContractForgiveListener(@NonNull OasisServer server, @NonNull EconomyState state) {
        super(server, state);
    }
