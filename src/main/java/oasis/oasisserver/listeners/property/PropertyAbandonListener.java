...
public final class PropertyAbandonListener extends OasisCommandTranslator {
    public PropertyAbandonListener(@NonNull OasisServer server, @NonNull EconomyState state) {
        super(server, state);
    }
