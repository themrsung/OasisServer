...
public final class PropertySetProtectorListener extends OasisCommandTranslator {
    public PropertySetProtectorListener(@NonNull OasisServer server, @NonNull EconomyState state) {
        super(server, state);
    }
