...
public final class PropertyClaimListener extends OasisCommandTranslator {
    public PropertyClaimListener(@NonNull OasisServer server, @NonNull EconomyState state) {
        super(server, state);
    }
