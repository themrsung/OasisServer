...
public final class CardTerminalCreateListener extends OasisCommandTranslator {
    public CardTerminalCreateListener(@NonNull OasisServer server, @NonNull EconomyState state) {
        super(server, state);
    }
