...
public final class VaultSetKeeperListener extends OasisCommandTranslator {
    public VaultSetKeeperListener(@NonNull OasisServer server, @NonNull EconomyState state) {
        super(server, state);
    }
