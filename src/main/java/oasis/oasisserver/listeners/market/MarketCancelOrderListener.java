...
public final class MarketCancelOrderListener extends OasisCommandTranslator {
    public MarketCancelOrderListener(@NonNull OasisServer server, @NonNull EconomyState state) {
        super(server, state);
    }
