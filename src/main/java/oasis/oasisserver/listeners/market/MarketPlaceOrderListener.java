...
public final class MarketPlaceOrderListener extends OasisCommandTranslator {
    public MarketPlaceOrderListener(@NonNull OasisServer server, @NonNull EconomyState state) {
        super(server, state);
    }
