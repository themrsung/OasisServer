...
public final class MarketDelistAssetListener extends OasisCommandTranslator {
    public MarketDelistAssetListener(@NonNull OasisServer server, @NonNull EconomyState state) {
        super(server, state);
    }
